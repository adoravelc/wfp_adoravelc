                ...
                <form action="{{ route('foods.update', $food->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" class="form-control" id="name" 
                                    placeholder="Enter food name" value="{{ old('name', $food->name) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="description" class="form-control" id="description" 
                            rows="3" placeholder="Enter food description" required>{{ old('description', $food->description) }}</textarea>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="price" class="form-control" id="price" 
                                placeholder="Enter price" value="{{ old('price', $food->price) }}" min="0" step="1" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="nutrition_facts" class="form-control" id="nutrition_facts" 
                            rows="3" placeholder="Example: Protein 10g, Carbs 25g, Fat 5g, etc." required>{{ old('nutrition_facts', $food->nutrition_facts) }}</textarea>
                    </div>
...
@section('judul-halaman', 'Edit Food')
@section('judul-browser', 'Edit Food')